        ...
        <aside class="lg:col-span-5">
          <div class="sticky top-6 rounded-2xl border border-zinc-700/80 bg-zinc-900/50 p-6 shadow-md backdrop-blur-sm sm:p-8">
            ...
            <button
              ...
              type="button"
              class="mt-6 w-full rounded-lg bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-zinc-900 hover:scale-[1.02] active:scale-[0.98]"
