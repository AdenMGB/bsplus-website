      ...
      <div class="mx-auto max-w-4xl">
        <div class="mb-8 sm:mb-12">
          ...
          <p class="mt-4 text-base sm:text-lg leading-7 sm:leading-8 text-zinc-300">
            Complete release history and updates for DesQTA.
          </p>
        </div>
        ...
        <div v-else class="space-y-4">
          ...
          >
            <button
              ...
              class="flex w-full items-center justify-between p-6 sm:p-8 text-left focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75"
            >
              ...
              <div class="pt-4 border-t border-zinc-700/50">
                ...
                <div class="mt-6">
                  <a
                    ...
                    class="inline-flex items-center text-sm font-semibold text-zinc-400 hover:text-blue-300 transition-colors"
                  >
                    View on GitHub
...
const loadReleases = async (page: number, append = false) => {
  try {
    ...
    const response = await fetch(`/api/changelogs/desqta?page=${page}&per_page=10`);
    if (!response.ok) {
