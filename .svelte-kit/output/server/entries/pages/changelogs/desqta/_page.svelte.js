...
//#region src/routes/changelogs/desqta/+page.svelte
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<section class="mx-auto max-w-5xl space-y-8 pb-14 pt-6"><a class="nav-link text-sm" href="/changelogs">← Back to Changelogs</a> <div class="space-y-3"><div class="section-subtitle">DesQTA changelog</div> <h1 class="section-title">Complete release history for the desktop app.</h1></div> <div class="space-y-4"><!--[-->`);
